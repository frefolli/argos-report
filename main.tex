...
<SPIEGARE BREVEMENTE STRATEGIE>

Inoltre si \`e visto come inizializzare con Nearest i target assegnati ai droni porta a  mantenere la distanza media che gli stessi devono percorrere durante la missione inferiore a un inizializzazione Random.

Con asseganmento iniziale Random i metodi Probable Minority, tanto più è pbobabile la rilocazione, tanto pi\`u generano squadroni squilibrati nel numero di droni che gli appartengono.
...
Il potenziale LP è risultato il più adatto a garantire una distanza minima tra i droni in volo.
