...
Sempre su questo tema, un iniziaizzazione Nearest con mancanza di review successiva, fa raggiunege il minimo globale per quanto riguarda la distanza media che ogni drone deve percorrere, dato che dopo 200 iterazioni circa i droni sono gi\`a arrivati a destinazione.
...
Sono state eseguite diverse simulazioni che hanno evidenziato aspetto positivi e negativi delle strategie implementate, rispetto anche a diversi scenari (rumore si/rumore no, e un potenziale tra LP, GP e JP).
...
Con asseganmento iniziale Random, vale che per i metodi Probable Minority, tanto più è probabile la rilocazione, tanto pi\`u essi generano squadroni squilibrati nel numero di droni che gli appartengono.
